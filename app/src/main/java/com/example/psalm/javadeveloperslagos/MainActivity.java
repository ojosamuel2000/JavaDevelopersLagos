...
import static com.example.psalm.javadeveloperslagos.R.id.profile;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DevelopersAdapter(this, new ArrayList<DevelopersList>());
        ...
        devListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                DevelopersList currentDeveloper = mAdapter.getItem(position);

                // Convert the String URL into a URI object (to pass into the Intent constructor)
                String developerImg = "";
                if (!currentDeveloper.equals("")) {
    ...
    private class DevelopersAsyncTask extends AsyncTask<String, Void, List<DevelopersList>> {
         ...
         */
        @Override
        protected List<DevelopersList> doInBackground(String... urls) {
            if(urls.length < 1 || urls[0] == null) {
                return null;
            }

            List<DevelopersList> result = QueryUtils.fetchDevelopersData(urls[0]);
            return result;
        }

        @Override
        protected void onPostExecute(List<DevelopersList> data) {
