...
import static com.example.psalm.javadeveloperslagos.MainActivity.LOG_TAG;
...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link DevelopersList} objects that has been built up from
     * parsing a JSON response.
     */

    public static List<DevelopersList> fetchDevelopersData(String requestUrl) {
        // Create URL object
        ...
        List<DevelopersList> devs = extractDevelopers(jsonResponse);

        // Return the {@link Event}
        return devs;
    }

    public static List<DevelopersList> extractDevelopers(String devsJSON) {
        ...
        List<DevelopersList> devs = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < devsArray.length(); i++) {
                ...
                //
                DevelopersList dev = new DevelopersList(login, url, avatar_url);
